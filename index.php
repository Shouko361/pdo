    ...
    <?php
        ...
        if(isset($_POST['nome'])){
            ...
            if(!empty($nome) && !empty($telefone) && !empty($email) && !empty($profissao) && !empty($nascimento) && !empty($sexo) && !empty($peso) && !empty($altura) && !empty($nacionalidade)){
                ...
                //Cadastra o usuario
                if($cad->cadastro($nome,$telefone,$email,$profissao,$nascimento,$sexo,$peso,$altura,$nacionalidade)){
    ...
    <section id="cadastro">
        <form action="" method="POST">
            ...
            <label for="SexoF">F</label>
                <input type="radio" name="sexo" id="sexoF"><p></p>
            <label for="peso">Peso: </label>
                <input type="number" name="peso" id="peso" placeholder="Ex: 60.00"><p></p>
            <label for="altura">Altura: </label>
                <input type="number" name="altura" id="altura" placeholder="Ex: 160cm"><p></p>
        ...
        <?php
            ...
            if(count($dados) > 0)
            {
                ...
                { 
                    ...
                    ?>
                    <td><a href="">Exluir</a><a href="">Editar</a></td>
                    <?php
                    echo"</tr>";
